	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'b4st' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'b4st' ); ?></th>
			</tr>
		</thead>
		<tbody>
